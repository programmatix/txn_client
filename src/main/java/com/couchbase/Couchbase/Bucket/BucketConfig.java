...
public class BucketConfig {
  ...
  public Bucket.BucketType getbucketType(String bucketType){
    switch (bucketType) {
      case "COUCHBASE":
  ...
  public Bucket.EphemeralBucketEvictionPolicy getevictionPolicy(String evictionPolicy){
    switch (evictionPolicy) {
      case "NRUEVICTION":
        return Bucket.EphemeralBucketEvictionPolicy.NRUEVICTION;
      case "NOEVICTION" :
        return Bucket.EphemeralBucketEvictionPolicy.NOEVICTION;
      default:
        throw new IllegalArgumentException("Incorrect bucket type");
    }
    }
